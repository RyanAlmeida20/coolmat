...
function coolmat_scripts() {
	...
	wp_enqueue_style('coolmat-custom', get_template_directory_uri() . 
	'./css/custom.css');
	
	wp_style_add_data( 'coolmat-style', 'rtl', 'replace' );

	wp_enqueue_script( 'coolmat-navigation', get_template_directory_uri() . 
	'/js/navigation.js', array(), _S_VERSION, true );
...
function no_wpautop_shortcode( $atts, $content = null ) {
    return $content;
}
add_shortcode( 'no_wpautop', 'no_wpautop_shortcode' );
